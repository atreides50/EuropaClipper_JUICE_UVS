;$Date: 2016/06/01 18:53:35 $
;$Header: /home/cdaweb/dev/control/RCS/plot_map_images.pro,v 1.164 2016/06/01 18:53:35 ryurow Exp ryurow $
;$Locker: ryurow $
;$Revision: 1.164 $
;
;--------------------------------------------------------------
...
; Added by Ron Yurow (31 May 2016)
IF  STRPOS (STRUPCASE (logical_source), 'TEST') eq  -1 THEN OLD_VIS = 1 ELSE OLD_VIS = 0

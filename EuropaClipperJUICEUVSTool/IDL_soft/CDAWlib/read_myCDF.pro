;$Author: ryurow $
;$Date: 2016/11/10 22:11:38 $
;$Header: /home/cdaweb/dev/control/RCS/read_myCDF.pro,v 1.336 2016/11/10 22:11:38 ryurow Exp ryurow $
;$Locker: ryurow $
;$Revision: 1.336 $
;+------------------------------------------------------------------------
...
if (error_status ne 0) then begin
  ...
  IF  (error_status eq -5) THEN BEGIN
      ...
      val_data= "DATASET=" + tempnm
      val_err = "ERROR="   + !ERR_STRING
      val_msg = "STATUS="  + !ERR_STRING

      ; Create an error structure to return.
      err_struct = CREATE_STRUCT ('DATASET', val_data, 'ERROR', val_err, 'STATUS', val_msg)

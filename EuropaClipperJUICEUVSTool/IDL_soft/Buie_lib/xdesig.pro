...
;  2015/04/26, MWB, changed to collect up oblist warnings to the end
;-
   ...
   for i=0L,nfiles-1 do begin
      ...
      for j=0L,nlist-1 do begin
         ...
         if chkoblist then begin
	       ...
	       oblistwarn=[oblistwarn, $
	                   oblistid[z]+' in oblist and now designated: '+ $
			   dlist[idx1,j]]
            endif
         endif
         ...
         if not nodb then begin
	       ...
	       print,localid,' is not present in the database.'
               chkresult=''
            endelse
...
;                  print,'Code ',dlist[idx0,j],', redundant tag: ',info[z]
   ...
   if oblistwarn ne [] then print,oblistwarn

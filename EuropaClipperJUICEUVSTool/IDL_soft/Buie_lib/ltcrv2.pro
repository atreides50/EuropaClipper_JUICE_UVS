...
pro ltcrv2,stand,fil,jd,time,am,serial,inst,instsig,in_color,in_colorsig, $
   doobj,doser,dofil,tran,transig,jdref,refcolor,refam,jdobs,tobs,std,stdsig, $
...
;   endif
   ...
   if n10 ne 7 or n11 ne 7 then begin
      print,self + 'Error!  tran and transig must be 7 element vectors.'
      return
   endif
...
;         if nobs gt 0 then print, stand[z], fil[z], serial[z]
   ...
   inst2std,jd[z],am[z],inst[z],instsig[z],color[z],colorsig[z], $
      tran,transig,jdref,std,stdsig,refcolor=refcolor,refam=refam

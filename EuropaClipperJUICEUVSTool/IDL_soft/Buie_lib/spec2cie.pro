   ...
   if rank eq 1 then begin
      ...
      if showsummary then begin
         ...
         plot,refwp,ispec,yr=[0.0,max([ispec,1.0])],/nodata, $
            ...
            background='cfcfcf'xl,color='000000'xl,charsize=1.5
         oplot,refwp,ispec,color=color,thick=7
         oplot,wave,spec,psym=4,color=0
         oplot,refw,xbar/allmax/subsample,color='0000cf'xl,psym=4
         oplot,refwp,xbarp/allmax,color='0000cf'xl,thick=2
         oplot,refw,ybar/allmax/subsample,color='00cf00'xl,psym=4
         oplot,refwp,ybarp/allmax,color='00cf00'xl,thick=2
         oplot,refw,zbar/allmax/subsample,color='cf0000'xl,psym=4
         oplot,refwp,zbarp/allmax,color='cf0000'xl,thick=2
         dy=0.035
         xpos=0.89
         top=0.5
         xyouts,xpos,top,'CIE',/normal,color='000000'xl,charsize=2.0,align=0.5
         str1='x='+string(x,format='(f5.3)')
         xyouts,xpos,top-dy,str1,/normal,color='000000'xl,charsize=2.0,align=0.5
         str1='y='+string(y,format='(f5.3)')
         xyouts,xpos,top-dy*2,str1,/normal,color='000000'xl,chars=2.0,align=0.5
         str1='Y='+string(bigy,format='(f5.3)')
         xyouts,xpos,top-dy*3,str1,/normal,color='000000'xl,chars=2.0,align=0.5
         xyouts,xpos,top-dy*4.5,'RGB',/normal,col='000000'xl,chars=2.0,align=0.5
         str1=string(r,g,b,format='(Z2.2,1x,Z2.2,1x,Z2.2)')
         xyouts,xpos,top-dy*5.5,str1,/normal,col='000000'xl,chars=2.0,align=0.5
      endif
   endif
